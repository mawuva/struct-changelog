...
def main():
        ...
        "company": {
            ...
            "departments": {
                "engineering": {
                    ...
                    "employees": [
                        {"name": "Bob Smith", "role": "Senior Developer", "skills": ["Python", "JavaScript"]},
                        {"name": "Carol Davis", "role": "DevOps Engineer", "skills": ["Docker", "Kubernetes"]}
                    ],
                    "budget": 500000
                },
                "marketing": {
                    ...
                    "employees": [
                        {"name": "Eve Brown", "role": "Marketing Manager", "skills": ["SEO", "Analytics"]}
                    ],
                    "budget": 200000
                }
            },
    ...
    with changelog.capture(data) as d:
        ...
        d["company"]["departments"]["sales"] = {
            ...
            "employees": [
                {"name": "Grace Lee", "role": "Sales Director", "skills": ["CRM", "Negotiation"]}
            ],
            "budget": 300000
        }
        
        # Modifier un employé existant
        d["company"]["departments"]["engineering"]["employees"][0]["skills"].append("React")
    ...
    print(f"  Employés en ingénierie: {len(data['company']['departments']['engineering']['employees'])}")
