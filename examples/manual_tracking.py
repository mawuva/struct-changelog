...
def main():
    ...
    changelog.add(
        action=ChangeActions.ADDED, key_path="user.email", new_value="john@example.com"
    )

    changelog.add(action=ChangeActions.ADDED, key_path="user.age", new_value=30)

    changelog.add(
        action=ChangeActions.ADDED, key_path="user.preferences.theme", new_value="dark"
    )

    changelog.add(
        action=ChangeActions.ADDED, key_path="user.preferences.language", new_value="fr"
    )
    ...
    changelog.add(
        action=ChangeActions.ADDED, key_path="user.hobbies[0]", new_value="programming"
    )

    changelog.add(
        action=ChangeActions.ADDED, key_path="user.hobbies[1]", new_value="reading"
    )

    changelog.add(
        action=ChangeActions.ADDED, key_path="user.hobbies[2]", new_value="gaming"
    )
    ...
    changelog.add(
        action=ChangeActions.ADDED, key_path="user.address.city", new_value="New York"
    )

    changelog.add(
        action=ChangeActions.ADDED, key_path="user.address.country", new_value="USA"
    )
    ...
    changelog.add(
        action=ChangeActions.ADDED, key_path="new_session.id", new_value="session_123"
    )
