...
@contextmanager
def track_changes(data: Any, prefix: str = "") -> Generator[Tuple[ChangeLogManager, Any], None, None]:
    """
...
class ChangeTracker:
    ...
    def add(self, action, key_path: str, old_value: Any = None, new_value: Any = None) -> None:
        """
        Add a new entry to the changelog manually.
        
        Args:
            action: The type of change (from ChangeActions enum).
